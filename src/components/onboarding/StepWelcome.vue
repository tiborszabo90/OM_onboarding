<template>
  <div>
    <div class="mb-12">
      <h2 class="text-4xl font-medium text-[#23262A] mb-4">Welcome to OptiMonk 🙌</h2>
      <p class="text-xl text-gray-400 max-w-[400px] font-light">
    ...
    <div class="space-y-5">
      ...
      <div>
        <label class="block text-lg font-medium text-[#23262A] mb-2">
        ...
        <input
          ...
          @input="updateData"
          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ED5A29] focus:border-transparent transition-colors text-[#23262A]"
