<template>
  <div>
    <div class="mb-8">
      ...
      <p class="text-base text-gray-400 font-light mt-4">Select whose contact information was used to create this account.</p>
    </div>
    ...
    <div class="space-y-3">
      <button
        ...
        class="w-full bg-white border-2 border-gray-200 rounded-xl p-4 hover:border-[#ED5A29] hover:shadow-md transition-all focus:outline-none focus:ring-2 focus:ring-[#ED5A29] focus:ring-offset-2 text-left"
      >
